...
<!-- Animated tagline (starfield + typing), stored in repo so it always plays -->
<p align="center">
  <img width="100%" src="./assets/tagline.gif" alt="Generative AI - Deep Learning - Automation" />
</p>
...
| Project | Description |
| :--- | :--- |
| 🏥 [**Synthetic MedData Generation Model**](https://github.com/mralix007/Synthetic_MedData_Generation_Model) | Privacy-preserving synthetic medical data pipeline — hybrid encryption, class-conditional **CTGAN**, multi-metric privacy evaluation, and utility-gated controlled release. |
| 🤖 [**Hermes**](https://github.com/mralix007/Hermes) | Autonomous AI agent for Windows + WSL — UI automation, local OCR perception, a code-enforced operating doctrine, and a self-healing distributed fabric. |
